  ...
  <div class="page-outer">
    <div class="full-page">
      ...
      <div class="hw-login-button-outer" @click="clickHwidbtn">
        <hl-hwidbtn class="hw-login-button" :class="`${agreementChecked ? '' : 'hw-login-button-disable'}`"></hl-hwidbtn>
      ...
      <div class="agreement-hint">
        <div class="agreement-check" @click="agreementChecked = !agreementChecked">
        ...
        <div class="agreement-links-outer">
          <span>
            ...
            <span class="agreement-link" @click="jumpPage('loginPagePDF')">{{ agreementList[2].name }}</span>
    ...
    const callback = (res) => {
      if (res?.result === 'success') {
        try {
          ...
          const phoneNumber = data.data?.extraInfo?.quickLoginAnonymousPhone || '***********'
